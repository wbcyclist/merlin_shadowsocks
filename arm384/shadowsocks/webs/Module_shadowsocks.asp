...
function version_show() {
	...
	$.ajax({
		url: 'https://raw.githubusercontent.com/wbcyclist/merlin_shadowsocks/master/arm384/config.json.js',
		type: 'GET',
		dataType: 'json',
...
function toggle_func() {
	...
	$("#update_log").click(
		function() {
			window.open("https://github.com/wbcyclist/merlin_shadowsocks/blob/master/arm384/Changelog.txt");
		});
	$("#log_content2").click(
		function() {
			x = -1;
												...
												<th id="ss_switch">科学上网开关</th>
													<td colspan="2">
														...
														<div style="display:table-cell;float: left;margin-left:270px;position: absolute;padding: 5.5px 0px;">
															<a type="button" class="ss_btn" target="_blank" href="https://github.com/wbcyclist/merlin_shadowsocks/blob/master/arm384/Changelog.txt">更新日志</a>
														</div>
												...
												<script type="text/javascript">
													...
													$('#table_rules').forms([
														{ title: 'gfwlist域名数量', multi: [
															...
															{ suffix: '<a href="https://github.com/wbcyclist/merlin_shadowsocks/blob/master/rules/gfwlist.conf" target="_blank">' },
															{ suffix: '<i><% nvram_get("update_ipset"); %></i></a>' },
														]},
														{ title: '大陆白名单IP段数量', multi: [
															{ suffix: '<em>'+ chnl +'</em>&nbsp;行，包含 <em>' + chnn + '</em>&nbsp;个ip地址，版本：' },
															{ suffix: '<a href="https://github.com/wbcyclist/merlin_shadowsocks/blob/master/rules/chnroute.txt" target="_blank">' },
															{ suffix: '<i><% nvram_get("update_chnroute"); %></i></a>' },
														]},
														{ title: '国内域名数量（cdn名单）', multi: [
															{ suffix: '<em>'+ cdnn +'</em>&nbsp;条，版本：' },
															{ suffix: '<a href="https://github.com/wbcyclist/merlin_shadowsocks/blob/master/rules/cdn.txt" target="_blank">' },
