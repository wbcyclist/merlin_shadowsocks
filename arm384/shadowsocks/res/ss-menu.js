...
function openssHint(itemNum) {
	...
	if (itemNum == 1) {
		...
		statusmenu += "</br>&nbsp;&nbsp;&nbsp;&nbsp;wget --no-check-certificate https://raw.githubusercontent.com/hq450/fancyss_history_package/master/fancyss_arm384/shadowsocks_1.0.0.tar.gz";
		statusmenu += "</br>&nbsp;&nbsp;&nbsp;&nbsp;mv shadowsocks_1.0.0.tar.gz shadowsocks.tar.gz";
		...
		statusmenu = "shadowsocks规则更新包括了gfwlist模式中用到的<a href='https://github.com/wbcyclist/merlin_shadowsocks/blob/master/rules/gfwlist.conf' target='_blank'><font color='#00F'><u>gfwlist</u></font></a>，在大陆白名单模式和游戏模式中用到的<a href='https://github.com/wbcyclist/merlin_shadowsocks/blob/master/rules/chnroute.txt' target='_blank'><u><font color='#00F'>chnroute</font></u></a>和<a href='https://github.com/wbcyclist/merlin_shadowsocks/blob/master/rules/cdn.txt' target='_blank'><u><font color='#00F'>国内cdn名单</font></u></a>"
